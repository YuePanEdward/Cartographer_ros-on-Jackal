...
--first launch velodyne_pointcloud VLP16.launch (Lidar)
--then  launch kvh175 imu.launch (IMU,used as the initial value of trajectory)
  ...
  --two possibile configuration
  options = {
    map_builder = MAP_BUILDER,
    trajectory_builder = TRAJECTORY_BUILDER,
    map_frame = "map",
    tracking_frame = "kvh_link", --when using imu,you must use the imu's link. It's kvh_link here.
    published_frame = "base_link", -- on jackal, odom should be ok. but for rosbag, use base_link as other frames are based on baselink
